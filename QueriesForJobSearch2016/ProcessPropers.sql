...
--Update Total Word Count on keyterms
...
--Fill Counted Words on keyterms
Update AMM_ProcessProper Set CountedWords=TotalWords
Where InputId=@InputId
And KeyValue>0


--Fill Counted Weight (Distinct)
...
--Fill Total Weight on keyterms where there is none (ensure inclusion of key terms specified by user)
...
--Set Distinct Weight to full Total Weight on keyterms (ensure inclusion of key terms specified by user)
...
--Fill Weight Sum on keyterms where there is none (ensure inclusion of key terms specified by user)
...
--Additional weight on keyterms to increase association value
Update AMM_ProcessProper Set CountedWeightSum=CountedWeightSum*(KeyValue+1)
Where InputId=@InputId



--Set which terms to associate
